...
export class ClientsService {
  ...
  getClientById(id: number) {
    return this.http.get<GenericResponse<ClientDto>>(
   ...
   */
  searchClients(queryParams: GenericFilter) {
    return this.http.get(`${environment.apiUrl}/clients/search`, {
  ...
  createClient(createData: CreateClientDto) {
    return this.http.post<GenericResponse<{ client: ClientDto }>>(
  ...
  updateClient(id: number, updateData: UpdateClientDto) {
    return this.http.put<GenericResponse<{ client: ClientDto }>>(
      `${environment.apiUrl}/clients/${id}`,
      updateData
    );
  }
  ...
  deleteClient(id: number) {
    return this.http.delete<GenericResponse<{ client: ClientDto }>>(
      `${environment.apiUrl}/clients/${id}`
    );
  }
}
